...
sealed class HomeScreenAction {
    ...
    data class OnQuickActionClick(val app: AppData) : HomeScreenAction()
    data class OnQuickActionSet(val index: Int, val packageName: String) : HomeScreenAction()
    data class OnQuickActionAdd(val packageName: String) : HomeScreenAction()
    data class OnQuickActionRemove(val index: Int) : HomeScreenAction()
